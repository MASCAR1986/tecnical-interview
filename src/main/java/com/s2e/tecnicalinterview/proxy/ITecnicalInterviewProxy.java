...
public interface ITecnicalInterviewProxy {
	...
	public ProxyResponse<AccountInfoProxyListDTO> getAccountInfo(
	...
	public ProxyResponse<BalanceProxyDTO> getBalance(
			@RequestHeader(value = "Auth-Schema") String authSchema, 
			@RequestHeader(value = "apikey") String apiKey, 
	...
	public ProxyResponse<TransactionProxyListDTO> getTransaction(
			@RequestHeader(value = "Auth-Schema") String authSchema, 
			@RequestHeader(value = "apikey") String apiKey, 
			@PathVariable(name = "accountId") Long accountId, 
			@PathVariable(name = "fromAccountingDate") String fromAccountingDate, 
			@PathVariable(name = "toAccountingDate") String toAccountingDate
			);
	...
	public ProxyResponse<PaymentProxyResponse> addMoney(
			@RequestHeader(value = "Auth-Schema") String authSchema, 
			@RequestHeader(value = "apikey") String apiKey, 
			@RequestHeader(value = "X-Time-Zone") String xTimeZone, 
			@PathVariable(name = "accountId") Long accountId,
			@RequestBody PaymentProxyRequest request
			);
